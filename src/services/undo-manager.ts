...
//   - Изменение ширины колонок (colWidth)
//   - Изменение представления — сортировка/фильтр (view)
//   - Массовые операции (batch: заполнение, вставка, удаление)
//
// Все типы изменений лежат в одном стеке, поэтому Ctrl+Z отменяет действия
// строго в том порядке, в котором они выполнялись.
